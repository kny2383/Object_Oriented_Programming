...
void main() {
	...
	sub3.Initialize("컴퓨터", 3, "C ");  // 인자값으로 멤버변수 초기화
	
	// 접근자 함수 TEST 출력 코드
	cout << "\n" << "sub2 이름: " << sub2.GetName() << "\n"; 
	cout << "\n" << "sub2 학점: " << sub2.GetHakjum() << "\n";
	cout << "\n" << "sub2 등급: " << sub2.GetGrade() << "\n";
	cout << "\n" << "sub2 평점: " << sub2.GetGPA() << "\n";

	cout << "\n" << "sub3 이름: " << sub3.GetName() << "\n";
	cout << "\n" << "sub3 학점: " << sub3.GetHakjum() << "\n";
	cout << "\n" << "sub3 등급: " << sub3.GetGrade() << "\n";
	cout << "\n" << "sub3 평점: " << sub3.GetGPA() << "\n";
}